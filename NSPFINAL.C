...
void main()
{
    ...
    setcolor(1);
    line(248,100,298,100);
    line(298,100,319,115);
    line(319,115,340,100);
    line(340,100,390,100);
    line(390,100,390,230);
    line(248,100,248,230);
    arc(319,230,180,255,71);
    arc(319,230,285,360,71);
    line(298,298,319,315);
    line(319,315,340,298);
    setfillstyle(1,RED);
    floodfill(250,102,1);
    setcolor(YELLOW);
    settextstyle(1,0,3);
